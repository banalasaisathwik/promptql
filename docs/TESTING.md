...
| Backend unit | `services/api/tests/unit` | Fake contracts, mocked GitHub HTTP normalization/errors, policy behavior, runtime transitions, and workflow execution | Configured with `unittest` discovery; no live GitHub calls |
