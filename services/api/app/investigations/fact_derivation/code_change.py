...
def derive_code_failure_facts(
    ...
    commit_changed_files = [
        item for item in evidence if isinstance(item.content, CommitChangedFileEvidenceContent)
    ]
    commit_hunks = [
        item for item in evidence if isinstance(item.content, CommitDiffHunkEvidenceContent)
    ]
